...
//******************************************************************************
//  クラス脕E：DataGridViewNumericCell
//  作成者　 ：張威
//  作成日　 ：2009-03-14
//  処历嘹容 ：用于输葋E档腉rid单元竵E
//  竵E侣臍s ：
//******************************************************************************
namespace Win.YMK.Controls.Grids.DataGridViewCells
{
    public class DataGridViewNumericCell : DataGridViewTextBoxCellEx
    {
        private static Type defaultEditType = typeof(DataGridViewNumericEditingCotrol);
        private static Type defaultValueType = typeof(System.Decimal);

        private DataGridViewNumericEditingCotrol EditingTextBox
        {
            get
            {
                return this.DataGridView.EditingControl as DataGridViewNumericEditingCotrol;
            }
        }
        ...
        {
            DataGridViewNumericCell dataGridViewCell = base.Clone() as DataGridViewNumericCell;
        ...
        private bool OwnsEditingControl(int rowIndex)
        {
            ...
            DataGridViewNumericEditingCotrol editingControl = this.DataGridView.EditingControl as DataGridViewNumericEditingCotrol;
