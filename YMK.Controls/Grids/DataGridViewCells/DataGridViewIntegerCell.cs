...
{
    public class DataGridViewIntegerCell : DataGridViewTextBoxCellEx
    {
        private static Type defaultEditType = typeof(DataGridViewIntegerEditingCotrol);
        private static Type defaultValueType = typeof(System.Int32);

        private DataGridViewIntegerEditingCotrol EditingTextBox
        {
            get
            {
                return this.DataGridView.EditingControl as DataGridViewIntegerEditingCotrol;
            }
        }
        ...
        {
            DataGridViewIntegerCell dataGridViewCell = base.Clone() as DataGridViewIntegerCell;
        ...
        private bool OwnsEditingControl(int rowIndex)
        {
            ...
            DataGridViewIntegerEditingCotrol editingControl = this.DataGridView.EditingControl as DataGridViewIntegerEditingCotrol;
