...
{
    public class DataGridViewAlpNumCell : DataGridViewTextBoxCellEx
    {
        private static Type defaultEditType = typeof(DataGridViewAlpNumEditingCotrol);
        private static Type defaultValueType = typeof(System.String);

        private DataGridViewAlpNumEditingCotrol EditingTextBox
        {
            get
            {
                return this.DataGridView.EditingControl as DataGridViewAlpNumEditingCotrol;
            }
        }
        ...
        {
            DataGridViewAlpNumCell dataGridViewCell = base.Clone() as DataGridViewAlpNumCell;
        ...
        public override void InitializeEditingControl(int rowIndex, object initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            AlphanumericTextBox editBox = this.DataGridView.EditingControl as AlphanumericTextBox;
            if (editBox != null)
            {
        ...
        public override void DetachEditingControl()
        {
            ...
            AlphanumericTextBox editBox = dataGridView.EditingControl as AlphanumericTextBox;
            if (editBox != null)
            {
        ...
        private bool OwnsEditingControl(int rowIndex)
        {
            ...
            DataGridViewAlpNumEditingCotrol editingControl = this.DataGridView.EditingControl as DataGridViewAlpNumEditingCotrol;
